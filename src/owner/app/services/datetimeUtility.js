(function () {
    ...
    function datetimeUtility($locale) {
        ...
        //about PME-1267, user can manually type in shortformat date e.g. 29/03/18
        //which not match the standard localeFormat, add convert function to detect
        //current date value is short locale format, then convert to standard localeformat if yes
        //add try and catch on the convert function, if input value is invalid, return original value
