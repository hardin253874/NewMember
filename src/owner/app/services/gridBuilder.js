        ...
        function TableDef (url, container, selector, data) {
            ...
            this.labelCol = function (title, field, width, $scope, entityType) {
                table.cols.push({
                    ...
                    sWidth: width || '20%',
                    mRender: function () {
                        return '<div class="grid-td-inner"><span ng-repeat="label in labels.array | limitTo: 5" pm-tooltip data-original-title="{{label.name}}" class="label label-default" ' +
            ...
            this.detailRow = function (detailCol, templateUrl, addToScope, fnOpenOnLoad) {
                var fnRender = new gridDetail(templateUrl, addToScope).render;
                table.detailRow = {detailCol: detailCol, mRender: fnRender, fnOpenOnLoad: fnOpenOnLoad};
                return  this;
            };
