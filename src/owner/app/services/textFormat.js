(function () {
    ...
    function createService ($filter, $locale, config) {
		...
		var service = {
            ...
            //return a string like "1:00 pm"
            timeIntToString: function (value) {
                var hrs = Math.floor(value / 100), mins = value - hrs * 100;
                if (hrs > 12) {
                    return (hrs - 12) + ':' + service.padNumber(mins, 2) + ' pm';
                } else if (hrs === 12 || hrs === '12') {
                    return hrs  + ':' + service.padNumber(mins, 2) + ' pm';
                } else {
            ...
            //takes string representing a time, like '9:00 pm' and turns it into a four digit
            // int like 2100,
