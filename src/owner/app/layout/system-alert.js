(function () {
    ...
    angular.module("app").controller('systemAlertController', ['$rootScope', 'server', 'config','permissionService', 'ux', systemAlertController]);

    function systemAlertController($rootScope, server, config, permissionService, ux) {
        var vm = this;
        vm.systemAlert = null;
